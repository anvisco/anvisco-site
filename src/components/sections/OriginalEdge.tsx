    ...
    <section className="bg-[var(--color-bg)] py-16 md:py-24 lg:py-32">
      <div className="mx-auto max-w-screen-xl px-6 lg:px-12">
        ...
        <motion.h2
          ...
          className="mb-6 max-w-[20ch] text-[2rem] font-medium leading-[1.1] tracking-[-0.02em] text-ink md:mb-8 md:text-[2.5rem]"
        >
        ...
        <div className="max-w-[60ch]">
          ...
          >
            ...
            <p className="max-w-[56ch] text-base leading-relaxed text-ink-muted md:text-[1.0625rem]">
